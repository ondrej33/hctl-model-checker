...
class Model:
    """Main structure containing the symbolic representation of the model

    Represents information of the Boolean network (update functions, ...)
    and the HCTL formula (state-variables, ...)
    ...
    Attributes:
        ...
        stable: BDD encoding for set of colored stable states (fixed points)
    """
